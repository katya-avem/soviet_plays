...
groups = {
    ...
    'historical_leaders': [
        ('Флаг адмирала.xml', '#ushakov'),
        ('Борьба без линии фронта.xml', '#peter_kondor'),
        ('Канун грозы.xml', '#prigorov'),
        ('Потопленные камни.xml', '#djemal'),
    ],
    'inoagent': [
    ...
    'prot_na_zapade': [
        ...
        ('Я хочу домой.xml', "#jenya"),  # Женя
    ],
    'uchenyi_patriot': [
        ('Победители.xml', '#lavrov'),  # Лавров
